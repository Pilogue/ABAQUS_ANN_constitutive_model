...
options = {
    ...
    'input':'Job_T_steelBrick_L10_W10_D1_Sa150_Sb450_dS12',
    'inputFormat':INP,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'Job_T_steelBrick_L10_W10_D1_Sa150_Sb450_dS12',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'listener_name':'LAPTOP-LDUUL3JB',
    'listener_resource':'16640',
    'magnetostatic':OFF,
    'massDiffusion':OFF,
    ...
    'mp_head_node':('laptop-lduul3jb', '192.168.143.222'),
    'mp_host_list':(('laptop-lduul3jb', 7),),
    'mp_mode':MPI,
    'mp_mode_requested':MPI,
    'mp_mpi_validate':OFF,
    'mp_rsh_command':'dummy %H -l ZX -n %C',
    'multiphysics':OFF,
    'noDmpDirect':[],
    'noMultiHost':[],
    'noMultiHostElemLoop':[],
