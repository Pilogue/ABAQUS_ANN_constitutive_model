...
# data
path = 'E:\piloguechin\Coderlife\\abaqusANN\ANN_training_module\data_steelBrick_2D'  # path where data is to be found
...
optimFunc = keras.optimizers.Nadam(lr=0.008, beta_1=0.95, beta_2=0.999, epsilon=1e-8) #这个参数3.7没有" , schedule_decay=0.005"
